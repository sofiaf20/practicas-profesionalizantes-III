class CalculatorView extends HTMLElement //canvas o caja html
{
	...
	alHacerClickEnBoton0()
	{
    	this.display.value += "0";
	}
	alHacerClickEnBoton1()
	{
    	this.display.value += "1";
	}
	alHacerClickEnBoton2()
	{
    	this.display.value += "2";
	}
	alHacerClickEnBoton3()
	{
    	this.display.value += "3";
	}
	alHacerClickEnBoton4()
	{
    	this.display.value += "4";
	}
	alHacerClickEnBoton5()
	{
    	this.display.value += "5";
	}
	alHacerClickEnBoton6()
	{
    	this.display.value += "6";
	}
	alHacerClickEnBoton7()
	{
    	this.display.value += "7";
	}
	alHacerClickEnBoton8()
	{
    	this.display.value += "8";
	}
	alHacerClickEnBoton9()
	{
    	this.display.value += "9";
	}
	alHacerClickEnBotonSuma()
	{
    	this.display.value += "+";
	}
	alHacerClickEnBotonResta()
	{
    	this.display.value += "-";
	}
	alHacerClickEnBotonDivi()
	{
    	this.display.value += "/";
	}
	alHacerClickEnBotonMulti()
	{
    	this.display.value += "*";
	}
	alHacerClickEnBotonDeci()
	{
    	this.display.value += ".";
	}
    ...
    connectedCallback(){
		...
		this.button0.addEventListener("click", (event) => this.alHacerClickEnBoton0(event));
		this.button1.addEventListener("click", (event) => this.alHacerClickEnBoton1(event) );
		this.button2.addEventListener("click", (event) => this.alHacerClickEnBoton2(event) );
		this.button3.addEventListener("click", (event) => this.alHacerClickEnBoton3(event) );
		this.button4.addEventListener("click", (event) => this.alHacerClickEnBoton4(event) );
		this.button5.addEventListener("click", (event) => this.alHacerClickEnBoton5(event) );
		this.button6.addEventListener("click", (event) => this.alHacerClickEnBoton6(event) );
		this.button7.addEventListener("click", (event) => this.alHacerClickEnBoton7(event) );
		this.button8.addEventListener("click", (event) => this.alHacerClickEnBoton8(event) );
		this.button9.addEventListener("click", (event) => this.alHacerClickEnBoton9(event) );
		this.buttonPlus.addEventListener("click", (event) => this.alHacerClickEnBotonSuma(event) );
		this.buttonMinus.addEventListener("click", (event) => this.alHacerClickEnBotonResta(event));
		this.buttonMulti.addEventListener("click", (event) => this.alHacerClickEnBotonMulti(event));
		this.buttonDivi.addEventListener("click", (event) => this.alHacerClickEnBotonDivi(event));
		this.buttonDeci.addEventListener("click", (event) => this.alHacerClickEnBotonDeci(event));
		this.Equalbutton.addEventListener("click", (event) => this.alHacerClickEnBotonIgual(event));
		this.deleteButton.addEventListener("click", (event) => this.alHacerClickEnBotonBorrar(event));
    }
